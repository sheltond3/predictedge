#!/bin/bash
echo "=== PredictEdge Full Fix Script ==="
echo "Running from: $(pwd)"
echo "Make sure this is your predictedge folder and you have internet."
read -p "Press Enter to begin (Ctrl+C anytime to stop)..."

echo "=== Step 1: Recreating component files ==="
...
EOL
echo "✓ MarketGauge.tsx done"
read -p "Press Enter to continue to next component..."
...
EOL
echo "✓ AffiliateBanner.tsx done"
read -p "Press Enter to continue to page.tsx fix..."

echo "=== Step 2: Fixing page.tsx with full TypeScript types ==="
...
EOL
echo "✓ page.tsx fixed with proper types"
read -p "Press Enter to continue to dependency upgrade..."

echo "=== Step 3: Upgrading to patched Next.js (fixes security warning) ==="
npm install next@15.2.3 react@18.3.1 react-dom@18.3.1 recharts@2.15.1 lucide-react@0.441.0 date-fns@3.6.0 --save
echo "✓ Dependencies updated"
read -p "Press Enter to commit & push..."

echo "=== Step 4: Git commit & push ==="
git add .
git commit -m "fix: full typed components + patched Next.js via setup script"
git push
echo "=== ALL DONE! ==="
echo "Now go to your Vercel dashboard → predictedge project → click Redeploy (or it may auto-trigger)."
echo "Your site will be live in ~30 seconds with the exact preview I showed earlier."
